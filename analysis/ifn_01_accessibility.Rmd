...
```{r echo=FALSE, fig.cap="Mean phastCons sequence conservation scores of gained OCRs."}
knitr::include_graphics("figure/ifn_01_accessibility.Rmd/plot-cons.png", error=FALSE)
```
